...
namespace CIS_264_Price_APP.Controllers.MiscellaneousControllers
{
    public class Misc_Q_SController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Misc_Q_S_ID,Category,Name,Price")] Misc_Q_S misc_Q_S)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Misc_Q_S_ID,Category,Name,Price")] Misc_Q_S misc_Q_S)
        {
            if (ModelState.IsValid)
            {
