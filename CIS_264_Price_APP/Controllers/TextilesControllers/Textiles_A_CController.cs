...
namespace CIS_264_Price_APP.Controllers.TextilesControllers
{
    public class Textiles_A_CController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Textiles_A_C_ID,Category,Name,Price")] Textiles_A_C textiles_A_C)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Textiles_A_C_ID,Category,Name,Price")] Textiles_A_C textiles_A_C)
        {
            if (ModelState.IsValid)
            {
