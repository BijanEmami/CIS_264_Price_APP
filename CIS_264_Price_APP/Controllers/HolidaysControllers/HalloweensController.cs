...
namespace CIS_264_Price_APP.Controllers.HolidaysControllers
{
    public class HalloweensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Halloween_ID,Category,Name,Price")] Halloween halloween)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Halloween_ID,Category,Name,Price")] Halloween halloween)
        {
            if (ModelState.IsValid)
            {
