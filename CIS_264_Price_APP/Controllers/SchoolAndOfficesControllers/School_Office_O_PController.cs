...
namespace CIS_264_Price_APP.Controllers.SchoolAndOfficesControllers
{
    public class School_Office_O_PController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "School_Office_O_P_ID,Category,Name,Price")] School_Office_O_P school_Office_O_P)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "School_Office_O_P_ID,Category,Name,Price")] School_Office_O_P school_Office_O_P)
        {
            if (ModelState.IsValid)
            {
