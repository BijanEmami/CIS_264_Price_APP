...
namespace CIS_264_Price_APP.Controllers.ArtsAndCraftsControllers
{
    public class Arts_Crafts_R_SController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Arts_Crafts_R_S_ID,Category,Name,Price")] Arts_Crafts_R_S arts_Crafts_R_S)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Arts_Crafts_R_S_ID,Category,Name,Price")] Arts_Crafts_R_S arts_Crafts_R_S)
        {
            if (ModelState.IsValid)
            {
