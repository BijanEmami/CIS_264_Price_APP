...
namespace CIS_264_Price_APP.Controllers.ArtsAndCraftsControllers
{
    public class Arts_Crafts_A_CController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Arts_Crafts_A_C_ID,Category,Name,Price")] Arts_Crafts_A_C arts_Crafts_A_C)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Arts_Crafts_A_C_ID,Category,Name,Price")] Arts_Crafts_A_C arts_Crafts_A_C)
        {
            if (ModelState.IsValid)
            {
